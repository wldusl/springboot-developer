package me.gojiyeon.springbootedeveloper.config.oauth;
...
import me.gojiyeon.springbootedeveloper.util.CookieUtil;
...
public class OAuth2SuccessHandler extends SimpleUrlAuthenticationSuccessHandler {
    ...
    private final OAuth2AuthorizationRequestBasedOnCookieRepository authorizationRequestsRepository;
    ...
    private void clearAuthenticationAttributes(HttpServletRequest request, HttpServletResponse response) {
        ...
        authorizationRequestsRepository.removeAuthorizationRequestCookies(request, response);
    }
